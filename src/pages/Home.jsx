  ...
  const handleInstallClick = async () => {
    if (deferredPrompt) {
      ...
      if (isMobile) {
        ...
        alert('💻 To Install:\n\n1. Look for install icon (⊕) in address bar\nOR\n2. Browser menu → "Install Teacher Notes"');
      }
    }
  };
        ...
        {showInstallButton && (
          ...
          >
            <motion.button
              ...
              className="group relative bg-gradient-to-r from-green-500 to-emerald-500 text-white rounded-full p-4 shadow-2xl hover:shadow-green-500/50 transition-all duration-300"
            >
              ...
              <span className="absolute inset-0 rounded-full bg-gradient-to-r from-green-500 to-emerald-500"></span>
              <Download className="relative w-6 h-6" />
            </motion.button>
            ...
            <motion.button
              ...
              className="absolute -top-2 -left-2 bg-red-500 text-white rounded-full p-1.5 shadow-lg hover:bg-red-600 transition-colors"
            >
              <X className="w-3 h-3" />
            </motion.button>
          </motion.div>
